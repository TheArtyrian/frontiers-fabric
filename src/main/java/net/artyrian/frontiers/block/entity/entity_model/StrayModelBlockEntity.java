...
public class StrayModelBlockEntity extends BlockEntity
{
    ...
    {
        super(ModBlockEntities.STRAY_MODEL_BLOCKENTITY, pos, state);
    }
    ...
    public static void tick(World world, BlockPos pos, BlockState state, StrayModelBlockEntity blockEntity)
    {
