...
public class StrayModelBlock extends BlockWithEntity implements BlockEntityProvider
{
    public static final IntProperty ROTATION = Properties.ROTATION;
    public static final MapCodec<StrayModelBlock> CODEC = StrayModelBlock.createCodec(StrayModelBlock::new);
    ...
    public StrayModelBlock(Settings settings)
    {
        super(settings);
    ...
    {
        return world.isClient ? validateTicker(type, ModBlockEntities.STRAY_MODEL_BLOCKENTITY, StrayModelBlockEntity::tick) : null;
    }
    ...
    { return new StrayModelBlockEntity(pos, state); }
