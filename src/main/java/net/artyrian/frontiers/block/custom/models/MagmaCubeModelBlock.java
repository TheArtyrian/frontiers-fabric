...
public class MagmaCubeModelBlock extends BlockWithEntity implements BlockEntityProvider
{
    public static final IntProperty ROTATION = Properties.ROTATION;
    public static final MapCodec<MagmaCubeModelBlock> CODEC = MagmaCubeModelBlock.createCodec(MagmaCubeModelBlock::new);
    ...
    public MagmaCubeModelBlock(Settings settings)
    {
        super(settings);
    ...
    {
        return world.isClient ? validateTicker(type, ModBlockEntities.MAGMA_CUBE_MODEL_BLOCKENTITY, MagmaCubeModelBlockEntity::tick) : null;
    }
    ...
    @Nullable
    @Override
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) { return new MagmaCubeModelBlockEntity(pos, state); }
