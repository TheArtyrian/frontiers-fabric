...
public class SlimeModelBlock extends BlockWithEntity implements BlockEntityProvider
{
    public static final IntProperty ROTATION = Properties.ROTATION;
    public static final MapCodec<SlimeModelBlock> CODEC = SlimeModelBlock.createCodec(SlimeModelBlock::new);
    ...
    public SlimeModelBlock(Settings settings)
    {
        super(settings);
    ...
    {
        return world.isClient ? validateTicker(type, ModBlockEntities.SLIME_MODEL_BLOCKENTITY, SlimeModelBlockEntity::tick) : null;
    }
    ...
    @Nullable
    @Override
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) { return new SlimeModelBlockEntity(pos, state); }
