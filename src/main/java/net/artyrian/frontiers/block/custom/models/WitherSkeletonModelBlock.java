...
public class WitherSkeletonModelBlock extends BlockWithEntity implements BlockEntityProvider
{
    public static final IntProperty ROTATION = Properties.ROTATION;
    public static final MapCodec<WitherSkeletonModelBlock> CODEC = WitherSkeletonModelBlock.createCodec(WitherSkeletonModelBlock::new);
    ...
    public WitherSkeletonModelBlock(Settings settings)
    {
        super(settings);
    ...
    {
        return world.isClient ? validateTicker(type, ModBlockEntities.WITHER_SKELETON_MODEL_BLOCKENTITY, WitherSkeletonModelBlockEntity::tick) : null;
    }
    ...
    {
        return new WitherSkeletonModelBlockEntity(pos, state);
    }
