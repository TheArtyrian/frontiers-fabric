...
public class SkeletonModelBlock extends BlockWithEntity implements BlockEntityProvider
{
    public static final IntProperty ROTATION = Properties.ROTATION;
    public static final MapCodec<SkeletonModelBlock> CODEC = SkeletonModelBlock.createCodec(SkeletonModelBlock::new);
    ...
    public SkeletonModelBlock(Settings settings)
    {
        super(settings);
    ...
    {
        return world.isClient ? validateTicker(type, ModBlockEntities.SKELETON_MODEL_BLOCKENTITY, SkeletonModelBlockEntity::tick) : null;
    }
    ...
    {
        return new SkeletonModelBlockEntity(pos, state);
    }
