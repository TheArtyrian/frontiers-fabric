...
public class BoggedModelBlock extends BlockWithEntity implements BlockEntityProvider
{
    public static final IntProperty ROTATION = Properties.ROTATION;
    public static final MapCodec<BoggedModelBlock> CODEC = BoggedModelBlock.createCodec(BoggedModelBlock::new);
    ...
    public BoggedModelBlock(Settings settings)
    {
        super(settings);
    ...
    {
        return world.isClient ? validateTicker(type, ModBlockEntities.BOGGED_MODEL_BLOCKENTITY, BoggedModelBlockEntity::tick) : null;
    }
    ...
    @Nullable
    @Override
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) { return new BoggedModelBlockEntity(pos, state); }
