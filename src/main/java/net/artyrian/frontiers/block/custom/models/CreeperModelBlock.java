...
public class CreeperModelBlock extends BlockWithEntity implements BlockEntityProvider
{
    public static final IntProperty ROTATION = Properties.ROTATION;
    public static final MapCodec<CreeperModelBlock> CODEC = CreeperModelBlock.createCodec(CreeperModelBlock::new);
    ...
    public CreeperModelBlock(Settings settings)
    {
        super(settings);
    ...
    {
        return world.isClient ? validateTicker(type, ModBlockEntities.CREEPER_MODEL_BLOCKENTITY, CreeperModelBlockEntity::tick) : null;
    }
    ...
    @Nullable
    @Override
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) { return new CreeperModelBlockEntity(pos, state); }
