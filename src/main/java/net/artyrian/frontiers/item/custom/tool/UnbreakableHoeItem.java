...
public class UnbreakableHoeItem extends HoeItem implements Unbreakable
{
    private final Identifier BROKEN_ITEM_ID;

    public UnbreakableHoeItem(Identifier broken_item_id, ToolMaterial toolMaterial, Settings settings)
    {
