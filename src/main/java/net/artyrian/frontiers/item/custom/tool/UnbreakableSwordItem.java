...
public class UnbreakableSwordItem extends SwordItem implements Unbreakable
{
    private final Identifier BROKEN_ITEM_ID;

    public UnbreakableSwordItem(Identifier broken_item_id, ToolMaterial toolMaterial, Settings settings)
    {
    ...
    public void postDamageEntity(ItemStack stack, LivingEntity target, LivingEntity attacker)
    {
        ...
        if (returnItem == null) stack.damage(1, attacker, EquipmentSlot.MAINHAND);
        else
        {
            ItemStack stack2 = stack.damage(1, returnItem, attacker, EquipmentSlot.MAINHAND);
