...
{
    public SubzeroArrowItem(Item.Settings settings)
    {
        super(settings);
    }
    ...
    {
        SubzeroArrowEntity subzeroArrow = new SubzeroArrowEntity(world, pos.getX(), pos.getY(), pos.getZ(), stack.copyWithCount(1), null);
        subzeroArrow.pickupType = PersistentProjectileEntity.PickupPermission.ALLOWED;
        return subzeroArrow;
    }
}
