...
public class UnbreakableAxeItem extends AxeItem implements Unbreakable
{
    private final Identifier BROKEN_ITEM_ID;

    public UnbreakableAxeItem(Identifier broken_item_id, ToolMaterial toolMaterial, Settings settings)
    {
