...
public class PaleTridentEntity extends PersistentProjectileEntity
{
    private static final TrackedData<Byte> LOYALTY = DataTracker.registerData(PaleTridentEntity.class, TrackedDataHandlerRegistry.BYTE);
    private static final TrackedData<Boolean> ENCHANTED = DataTracker.registerData(PaleTridentEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    private boolean dealtDamage;
    public int returnTimer;

    public PaleTridentEntity(EntityType<? extends PaleTridentEntity> entityType, World world)
    {
        super(entityType, world);
    }

    public PaleTridentEntity(World world, LivingEntity owner, ItemStack stack)
    {
        super(ModEntity.PALE_TRIDENT, owner, world, stack, null);
        this.dataTracker.set(LOYALTY, this.getLoyalty(stack));
        this.dataTracker.set(ENCHANTED, stack.hasGlint());
    }

    public PaleTridentEntity(World world, double x, double y, double z, ItemStack stack)
    {
        super(ModEntity.PALE_TRIDENT, x, y, z, world, stack, stack);
        this.dataTracker.set(LOYALTY, this.getLoyalty(stack));
        this.dataTracker.set(ENCHANTED, stack.hasGlint());
    }
    ...
    protected ItemStack getDefaultItemStack() {
        return new ItemStack(ModItem.PALE_TRIDENT);
    }
