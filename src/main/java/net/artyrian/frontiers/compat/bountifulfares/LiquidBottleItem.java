...
// Source: https://github.com/Heccology/Bountiful-Fares/blob/1.21/src/main/java/net/hecco/bountifulfares/item/custom/LiquidBottleItem.java
public class LiquidBottleItem extends Item
{
    ...
    public LiquidBottleItem(List<StatusEffectInstance> effects, Settings settings) {
        super(settings);
