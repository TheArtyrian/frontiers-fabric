...
public class FishingBobberMixinNF
{
    ...
    private boolean invalidHalterMainHand(boolean original, @Local(ordinal = 0) ItemStack itemStack)
    {
        ...
        return original || itemStack.is(((BobberIntf)self).frontiers_1_21x$getParentItemStack().getItem());
    }
    ...
    {
        FishingHook self = (FishingHook)(Object)(this);
        return original || itemStack2.is(((BobberIntf)self).frontiers_1_21x$getParentItemStack().getItem());
    }
}
