...
public class SubzeroArrowEntity extends AbstractArrow
{
    ...
    {
        super(FREntity.SUBZERO_ARROW.get(), owner, world, stack, shotFrom);
    }

    public SubzeroArrowEntity(Level world, double x, double y, double z, ItemStack stack, @Nullable ItemStack shotFrom)
    {
        super(FREntity.SUBZERO_ARROW.get(), x, y, z, world, stack, shotFrom);
    }
    ...
    protected void doPostHurtEffects(LivingEntity target)
    {
        ...
        int time = 1000;
        boolean wearing_frostite = FRArmorBonus.wearingSetOf(target, FRArmorBonus.FROSTITE);
    ...
    protected ItemStack getDefaultPickupItem() {
        return new ItemStack(FRItems.SUBZERO_ARROW.get());
    }
}
