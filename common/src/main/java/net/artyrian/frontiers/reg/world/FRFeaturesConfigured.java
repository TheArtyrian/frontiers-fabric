...
import net.artyrian.frontiers.reg.content.FRFeature;
...
public class FRFeaturesConfigured
{
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context)
    {
        ...
        RuleTest hielostoneRule = new BlockMatchTest(FRBlocks.HIELOSTONE.get());
        RuleTest cragulstaneRule = new BlockMatchTest(FRBlocks.CRAGULSTANE.get());

        // Cobalt ore
        List<OreConfiguration.TargetBlockState> cobaltOres =
                List.of(OreConfiguration.target(stoneReplaceables, FRBlocks.COBALT_ORE.get().defaultBlockState()),
                        OreConfiguration.target(deepslateReplaceables, FRBlocks.DEEPSLATE_COBALT_ORE.get().defaultBlockState())
                );
        // Verdinite ore
        List<OreConfiguration.TargetBlockState> verdiniteOres =
                List.of(OreConfiguration.target(stoneReplaceables, FRBlocks.VERDINITE_ORE.get().defaultBlockState()),
                        OreConfiguration.target(deepslateReplaceables, FRBlocks.DEEPSLATE_VERDINITE_ORE.get().defaultBlockState())
                );
        // Vivulite ore
        List<OreConfiguration.TargetBlockState> vivuliteOres =
                List.of(OreConfiguration.target(stoneReplaceables, FRBlocks.VIVULITE_ORE.get().defaultBlockState()),
                        OreConfiguration.target(deepslateReplaceables, FRBlocks.DEEPSLATE_VIVULITE_ORE.get().defaultBlockState())
                );
        // Black Emerald ore
        List<OreConfiguration.TargetBlockState> blackEmeraldOres =
                List.of(OreConfiguration.target(stoneReplaceables, FRBlocks.BLACK_EMERALD_ORE.get().defaultBlockState()),
                        OreConfiguration.target(deepslateReplaceables, FRBlocks.DEEPSLATE_BLACK_EMERALD_ORE.get().defaultBlockState())
                );
        // Frostite ore
        List<OreConfiguration.TargetBlockState> frostiteOres =
                List.of(OreConfiguration.target(iceReplaceables, FRBlocks.FROSTITE_ORE.get().defaultBlockState())
                );
        ...
        register(
                ...
                new DiskConfiguration(
                        RuleBasedBlockStateProvider.simple(FRBlocks.QUICKSAND.get()),
        ...
        register(
                ...
                new TreeConfiguration.TreeConfigurationBuilder(
                        BlockStateProvider.simple(FRBlocks.RADIANT_BLIGHTED_BIRCH_LOG.get().defaultBlockState()
                                .setValue(TimeSwitchLogBlock.CAN_SWITCH, true)),
                        new StraightTrunkPlacer(5, 2, 0),
                        BlockStateProvider.simple(FRBlocks.BLIGHTED_BIRCH_LEAVES.get()),
        ...
        WeightedStateProvider crimProvider = new WeightedStateProvider(
                SimpleWeightedRandomList.<BlockState>builder()
                        .add(FRBlocks.CRIMCONE.get().defaultBlockState(), 100)
        );
        ...
        register(context, SNOW_DAHLIA_KEY, Feature.FLOWER,
                new RandomPatchConfiguration(
                        64, 6, 2, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(FRBlocks.SNOW_DAHLIA.get())))
                ));
        // Fungal Daffodil
        register(context, FUNGAL_DAFFODIL_KEY, Feature.FLOWER,
                new RandomPatchConfiguration(
                        64, 7, 3, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(FRBlocks.FUNGAL_DAFFODIL.get())))
                ));
        // Experiwinkle
        register(context, EXPERIWINKLE_KEY, Feature.FLOWER,
                new RandomPatchConfiguration(
                        2, 1, 1, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(FRBlocks.EXPERIWINKLE.get())))
                ));

        // Slime Trail
        register(context, SLIME_TRAIL_KEY, FRFeature.SLIME_TRAIL.get(), new NoneFeatureConfiguration());

        // Eboncork Spike
        register(context, EBONCORK_SPIKE_KEY, FRFeature.EBONCORK_SPIKE.get(), new NoneFeatureConfiguration());

        // Huge Fungal Daffodil
        register(
                context, HUGE_FUNGAL_DAFFODIL_KEY, FRFeature.HUGE_FUNGAL_DAFFODIL.get(),
                new HugeMushroomFeatureConfiguration(
                        BlockStateProvider.simple(FRBlocks.FUNGAL_DAFFODIL_BLOCK.get().defaultBlockState().setValue(HugeMushroomBlock.DOWN, false)),
        ...
        register(context, BRIMTAN_ORE_KEY, Feature.ORE, new OreConfiguration(cragulstaneRule, FRBlocks.BRIMTAN_ORE.get().defaultBlockState(), 5, 0.45F));
        register(context, HIELOSTONE_KEY, Feature.ORE, new OreConfiguration(baseStone, FRBlocks.HIELOSTONE.get().defaultBlockState(), 64));
