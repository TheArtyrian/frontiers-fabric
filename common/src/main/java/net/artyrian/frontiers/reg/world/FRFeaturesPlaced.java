...
public class FRFeaturesPlaced
{
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context)
    {
        ...
        PlacementUtils.register(
                context,
                CRIMCONE_PLACED_KEY,
                configuredFeatureRegistryEntryLookup.getOrThrow(FRFeaturesConfigured.CRIMCONE_KEY),
        ...
        PlacementUtils.register(
                ...
                configuredFeatureRegistryEntryLookup.getOrThrow(FRFeaturesConfigured.SNOW_DAHLIA_KEY),
        ...
        PlacementUtils.register(
                ...
                configuredFeatureRegistryEntryLookup.getOrThrow(FRFeaturesConfigured.EXPERIWINKLE_KEY),
        ...
        PlacementUtils.register(
                ...
                configuredFeatureRegistryEntryLookup.getOrThrow(FRFeaturesConfigured.FUNGAL_DAFFODIL_KEY),
                RarityFilter.onAverageOnceEvery(20),
                InSquarePlacement.spread(),
                PlacementUtils.HEIGHTMAP,
                BiomeFilter.biome()
        ...
        PlacementUtils.register(
                ...
                configuredFeatureRegistryEntryLookup.getOrThrow(FRFeaturesConfigured.QUICKSAND_KEY),
                CountPlacement.of(1),
                InSquarePlacement.spread(),
                PlacementUtils.HEIGHTMAP,
        ...
        PlacementUtils.register(
                ...
                configuredFeatureRegistryEntryLookup.getOrThrow(FRFeaturesConfigured.SLIME_TRAIL_KEY),
        ...
        PlacementUtils.register(
                ...
                configuredFeatureRegistryEntryLookup.getOrThrow(FRFeaturesConfigured.EBONCORK_SPIKE_KEY),
                CountPlacement.of(2),
                InSquarePlacement.spread(),
        ...
        // Ores
        register(context, COBALT_ORE_PLACED_KEY, configuredFeatureRegistryEntryLookup.getOrThrow(FRFeaturesConfigured.COBALT_ORE_KEY),
                FROrePlacement.modifiersWithCount(
                        5,
                        HeightRangePlacement.triangle(VerticalAnchor.absolute(-60), VerticalAnchor.absolute(12))
                )
        );

        register(context, VERDINITE_ORE_PLACED_KEY, configuredFeatureRegistryEntryLookup.getOrThrow(FRFeaturesConfigured.VERDINITE_ORE_KEY),
                FROrePlacement.modifiersWithCount(
                        3,
        ...
        register(context, VIVULITE_ORE_PLACED_KEY, configuredFeatureRegistryEntryLookup.getOrThrow(FRFeaturesConfigured.VIVULITE_ORE_KEY),
                FROrePlacement.modifiersWithCount(
                        4,
        ...
        register(context, FROSTITE_ORE_PLACED_KEY, configuredFeatureRegistryEntryLookup.getOrThrow(FRFeaturesConfigured.FROSTITE_ORE_KEY),
                FROrePlacement.modifiersWithCount(
                        16,
        ...
        register(
                context, BLACK_EMERALD_ORE_PLACED_KEY, configuredFeatureRegistryEntryLookup.getOrThrow(FRFeaturesConfigured.BLACK_EMERALD_ORE_KEY),
                FROrePlacement.modifiersWithCount(
                        10,
        ...
        register(context, BRIMTAN_ORE_PLACED_KEY, configuredFeatureRegistryEntryLookup.getOrThrow(FRFeaturesConfigured.BRIMTAN_ORE_KEY),
                FROrePlacement.modifiersWithCount(
                        10,
        ...
        register(context, HIELOSTONE_ICE_PLACED_KEY, configuredFeatureRegistryEntryLookup.getOrThrow(FRFeaturesConfigured.HIELOSTONE_ICE_MOD_KEY),
                FROrePlacement.modifiersWithCount(
                        16,
        ...
        register(context, HIELOSTONE_PLACED_KEY, configuredFeatureRegistryEntryLookup.getOrThrow(FRFeaturesConfigured.HIELOSTONE_KEY),
                FROrePlacement.modifiersWithCount(
                        12,
                        HeightRangePlacement.triangle(VerticalAnchor.absolute(-20), VerticalAnchor.absolute(128))
                )
