...
public class ModPotion
{
    ...
    public static final Holder<Potion> MAGMA_VISION = registerPotion("frontiers.magma_vision", () -> new Potion(new MobEffectInstance(ModStatusEffects.MAGMA_VISION, 1800, 0)));
    public static final Holder<Potion> LONG_MAGMA_VISION = registerPotion("frontiers.long_magma_vision", () -> new Potion(new MobEffectInstance(ModStatusEffects.MAGMA_VISION, 4200, 0)));
