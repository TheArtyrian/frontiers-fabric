...
public class FRTrimMaterials
{
    ...
    public static void bootstrap(BootstrapContext<TrimMaterial> registry)
    {
        register(registry, COBALT,
                FRItems.COBALT_INGOT.get(), Style.EMPTY.withColor(0x003AD8), 0.001F, Map.of(
                        FRArmorMaterials.COBALT_ARMOR_MATERIAL, "cobalt_darker"));

        register(registry, VERDINITE,
                FRItems.VERDINITE_INGOT.get(), Style.EMPTY.withColor(0x05A559), 0.002F, Map.of(
                        FRArmorMaterials.VERDINITE_ARMOR_MATERIAL, "verdinite_darker"));

        register(registry, VIVULITE,
                FRItems.VIVULITE_INGOT.get(), Style.EMPTY.withColor(0xBB144B), 0.003F, Map.of(
                        FRArmorMaterials.VIVULITE_ARMOR_MATERIAL, "vivulite_darker"));

        register(registry, FROSTITE,
                FRItems.FROSTITE_INGOT.get(), Style.EMPTY.withColor(0x409DC0), 0.004F, Map.of(
                        FRArmorMaterials.FROSTITE_ARMOR_MATERIAL, "frostite_darker"));

        register(registry, MOURNING_GOLD,
                FRItems.MOURNING_GOLD_INGOT.get(), Style.EMPTY.withColor(0xA28C86), 0.005F, Map.of(
                        FRArmorMaterials.MOURNING_GOLD_ARMOR_MATERIAL, "mourning_gold_darker"));

        register(registry, BRIMTAN,
                FRItems.BRIMTAN_INGOT.get(), Style.EMPTY.withColor(0xFF3A07), 0.006F, Map.of(
                        FRArmorMaterials.BRIMTAN_ARMOR_MATERIAL, "brimtan_darker"));
    }
