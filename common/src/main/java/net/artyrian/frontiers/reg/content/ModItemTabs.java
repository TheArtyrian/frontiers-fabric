...
public class ModItemTabs
{
    ...
    public static void tabBuilding()
    {
        ...
        BUILDING_BLOCKS.addAfter(Blocks.CUT_RED_SANDSTONE_SLAB, ModBlocks.CRUSTED_QUICKSAND.get());
        BUILDING_BLOCKS.addAfter(ModBlocks.CRUSTED_QUICKSAND.get(), ModBlocks.CRUSTY_SAND_BRICKS.get());
        BUILDING_BLOCKS.addAfter(ModBlocks.CRUSTY_SAND_BRICKS.get(), ModBlocks.CRUSTY_SAND_BRICK_STAIRS.get());
        BUILDING_BLOCKS.addAfter(ModBlocks.CRUSTY_SAND_BRICK_STAIRS.get(), ModBlocks.CRUSTY_SAND_BRICK_SLAB.get());
        BUILDING_BLOCKS.addAfter(ModBlocks.CRUSTY_SAND_BRICK_SLAB.get(), ModBlocks.CRUSTY_SAND_BRICK_WALL.get());
        BUILDING_BLOCKS.addAfter(ModBlocks.CRUSTY_SAND_BRICK_WALL.get(), ModBlocks.CRUSTED_RED_QUICKSAND.get());
        BUILDING_BLOCKS.addAfter(ModBlocks.CRUSTED_RED_QUICKSAND.get(), ModBlocks.CRUSTY_RED_SAND_BRICKS.get());
        BUILDING_BLOCKS.addAfter(ModBlocks.CRUSTY_RED_SAND_BRICKS.get(), ModBlocks.CRUSTY_RED_SAND_BRICK_STAIRS.get());
        BUILDING_BLOCKS.addAfter(ModBlocks.CRUSTY_RED_SAND_BRICK_STAIRS.get(), ModBlocks.CRUSTY_RED_SAND_BRICK_SLAB.get());
        BUILDING_BLOCKS.addAfter(ModBlocks.CRUSTY_RED_SAND_BRICK_SLAB.get(), ModBlocks.CRUSTY_RED_SAND_BRICK_WALL.get());
