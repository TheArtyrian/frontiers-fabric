...
public class FRDispenserActions
{
    ...
    {
        // Specialty Arrows
        DispenserBlock.registerProjectileBehavior(FRItems.BOUNCY_ARROW.get());
        DispenserBlock.registerProjectileBehavior(FRItems.DYNAMITE_ARROW.get());
        DispenserBlock.registerProjectileBehavior(FRItems.PRISMARINE_ARROW.get());
        DispenserBlock.registerProjectileBehavior(FRItems.SUBZERO_ARROW.get());
        DispenserBlock.registerProjectileBehavior(FRItems.WARP_ARROW.get());

        // Misc
        DispenserBlock.registerProjectileBehavior(FRItems.FRUITCAKE_SLICE.get());
        DispenserBlock.registerProjectileBehavior(FRItems.BAIT.get());
        DispenserBlock.registerProjectileBehavior(FRItems.GOLDEN_EGG.get());

        // Spawn Eggs
        DispenserBlock.registerBehavior(FRItems.CRAWLER_SPAWN_EGG.get(), SPAWN_EGG_BEHAVIOR);
        DispenserBlock.registerBehavior(FRItems.JUNGLE_SPIDER_SPAWN_EGG.get(), SPAWN_EGG_BEHAVIOR);
        DispenserBlock.registerBehavior(FRItems.PUMPKIN_GOLEM_SPAWN_EGG.get(), SPAWN_EGG_BEHAVIOR);
        DispenserBlock.registerBehavior(FRItems.CROW_SPAWN_EGG.get(), SPAWN_EGG_BEHAVIOR);
        DispenserBlock.registerBehavior(FRItems.GOLDEN_CHICKEN_SPAWN_EGG.get(), SPAWN_EGG_BEHAVIOR);
