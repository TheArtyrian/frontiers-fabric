...
public class FRNetworking
{
    ...
    public static class ToServer
    {
        public static void bottleMessageWrite(BottleMessageWritePayload payload, ServerPlayer player)
        {
            ...
            ItemStack signed = new ItemStack(FRItems.BOTTLED_MESSAGE.get());
            signed.set(FRDataComponents.BOTTLE_CONTENT.get(), new BottleContentComponent(Filterable.passThrough(text)));
