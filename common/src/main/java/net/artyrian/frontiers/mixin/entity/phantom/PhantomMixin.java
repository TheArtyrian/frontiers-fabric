package net.artyrian.frontiers.mixin.entity.phantom;
...
@Mixin(Phantom.class)
public abstract class PhantomMixin extends LivingEntityMixin
{
    @Override
    public void dropEquipmentHook(ServerLevel world, DamageSource source, boolean causedByPlayer, CallbackInfo ci)
    {
        ...
        {
            this.spawnAtLocation(ModBlocks.PHANTOM_MODEL.get());
