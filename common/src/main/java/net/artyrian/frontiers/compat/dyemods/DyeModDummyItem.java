...
{
    // Delicate Dyes
    public static Supplier<Item> CORAL_DYE;
    public static Supplier<Item> CANARY_DYE;
    public static Supplier<Item> WASABI_DYE;
    public static Supplier<Item> SACRAMENTO_DYE;
    public static Supplier<Item> SKY_DYE;
    public static Supplier<Item> BLURPLE_DYE;
    public static Supplier<Item> SANGRIA_DYE;
    public static Supplier<Item> ROSE_DYE;
    public static Supplier<Item> UMBER_DYE;
    public static Supplier<Item> LAVENDER_DYE;

    public static Supplier<Item> CORAL_BALL;
    public static Supplier<Item> CANARY_BALL;
    public static Supplier<Item> WASABI_BALL;
    public static Supplier<Item> SACRAMENTO_BALL;
    public static Supplier<Item> SKY_BALL;
    public static Supplier<Item> BLURPLE_BALL;
    public static Supplier<Item> SANGRIA_BALL;
    public static Supplier<Item> ROSE_BALL;
    public static Supplier<Item> UMBER_BALL;
    public static Supplier<Item> LAVENDER_BALL;
    ...
    private static Supplier<Item> registerItemDD(String name, Supplier<Item> item)
    {
        return VectorLib.REGISTRY.registerItem(Frontiers.DELICATE_DYES_ID, name, item);
    }
}
