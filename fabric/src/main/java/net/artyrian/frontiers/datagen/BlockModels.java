...
public class BlockModels
{
    ...
    public static final TexturedModel.Provider TEMPLATE_VIV_ANVIL_FACTORY = TexturedModel.createDefault(BlockModels::anvilBody, TEMPLATE_VIVULITE_ANVIL);
    ...
    public static void registerVivuliteAnvil(Block anvil, BlockModelGenerators modelGenerator) {
        ResourceLocation identifier = BlockModels.TEMPLATE_VIV_ANVIL_FACTORY.create(anvil, modelGenerator.modelOutput);
