                ...
                LootTable.lootTable()
                        .withPool(
                                ...
                                LootPool.lootPool()
                                        ...
                                        .add(LootItem.lootTableItem(ModItem.MUSIC_DISC_DIAPHRAGM).setWeight(1).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))))
                                        .add(LootItem.lootTableItem(ModItem.BRIMTAN_HELMET_UPGRADE_SMITHING_TEMPLATE).setWeight(1).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))))
                                        .add(LootItem.lootTableItem(ModItem.BRIMTAN_CHESTPLATE_UPGRADE_SMITHING_TEMPLATE).setWeight(1).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))))
                                        .add(LootItem.lootTableItem(ModItem.BRIMTAN_LEGGINGS_UPGRADE_SMITHING_TEMPLATE).setWeight(1).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))))
                                        .add(LootItem.lootTableItem(ModItem.BRIMTAN_BOOTS_UPGRADE_SMITHING_TEMPLATE).setWeight(1).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))))
                                        .add(LootItem.lootTableItem(ModItem.BRIMTAN_TOOL_UPGRADE_SMITHING_TEMPLATE).setWeight(1).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))))
                        ...
                        .withPool(
                                ...
                                LootPool.lootPool()
                                        ...
                                        .add(LootItem.lootTableItem(ModItem.ONYX_BONE).setWeight(5).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 4.0F))))
                                        ...
                                        .add(LootItem.lootTableItem(ModBlocks.CRAGULSTANE_BRICKS).setWeight(5).apply(SetItemCountFunction.setCount(UniformGenerator.between(3.0F, 7.0F))))
                                        .add(LootItem.lootTableItem(ModBlocks.BRIMMED_CRAGULSTANE_BRICKS).setWeight(5).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 6.0F))))
                        )
                        .withPool(
                                // Goods
                                LootPool.lootPool()
                                        ...
                                        .add(LootItem.lootTableItem(ModItem.BRIMTAN_CLUSTER).setWeight(1).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))))
                                        .add(LootItem.lootTableItem(ModItem.TABLET_FRAGMENT).setWeight(1).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                        )
        );
    }
}
