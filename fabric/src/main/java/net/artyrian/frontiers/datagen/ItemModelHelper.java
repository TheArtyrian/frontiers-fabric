...
public class ItemModelHelper
{
    ...
    private static final List<ItemModelHelper.TrimMaterial> TRIM_MATERIALS = List.of(
            // Frontiers
            new ItemModelHelper.TrimMaterial("cobalt", 0.001F, Map.of(FRArmorMaterials.COBALT_ARMOR_MATERIAL, "cobalt_darker")),
            new ItemModelHelper.TrimMaterial("verdinite", 0.002F, Map.of(FRArmorMaterials.VERDINITE_ARMOR_MATERIAL, "verdinite_darker")),
            new ItemModelHelper.TrimMaterial("vivulite", 0.003F, Map.of(FRArmorMaterials.VIVULITE_ARMOR_MATERIAL, "vivulite_darker")),
            new ItemModelHelper.TrimMaterial("frostite", 0.004F, Map.of(FRArmorMaterials.FROSTITE_ARMOR_MATERIAL, "frostite_darker")),
            new ItemModelHelper.TrimMaterial("mourning_gold", 0.005F, Map.of(FRArmorMaterials.MOURNING_GOLD_ARMOR_MATERIAL, "mourning_gold_darker")),
            new ItemModelHelper.TrimMaterial("brimtan", 0.006F, Map.of(FRArmorMaterials.BRIMTAN_ARMOR_MATERIAL, "brimtan_darker")),

            // Vanilla
            new ItemModelHelper.TrimMaterial("quartz", 0.1F, Map.of()),
            new ItemModelHelper.TrimMaterial("iron", 0.2F, Map.of(ArmorMaterials.IRON, "iron_darker")),
            new ItemModelHelper.TrimMaterial("netherite", 0.3F, Map.of(ArmorMaterials.NETHERITE, "netherite_darker")),
            new ItemModelHelper.TrimMaterial("redstone", 0.4F, Map.of()),
            new ItemModelHelper.TrimMaterial("copper", 0.5F, Map.of()),
            new ItemModelHelper.TrimMaterial("gold", 0.6F, Map.of(ArmorMaterials.GOLD, "gold_darker")),
            new ItemModelHelper.TrimMaterial("emerald", 0.7F, Map.of()),
            new ItemModelHelper.TrimMaterial("diamond", 0.8F, Map.of(ArmorMaterials.DIAMOND, "diamond_darker")),
            new ItemModelHelper.TrimMaterial("lapis", 0.9F, Map.of()),
            new ItemModelHelper.TrimMaterial("amethyst", 1.0F, Map.of())
    );

    record TrimMaterial(String name, float itemModelIndex, Map<Holder<ArmorMaterial>, String> overrideArmorMaterials)
    {
    ...
    public static void registerLumen(Block type, BlockModelGenerators generator)
    {
        ...
        generator.blockStateOutput
                .accept(MultiVariantGenerator.multiVariant(type)
                        .with(PropertyDispatch.property(FRBlockProperties.LUMEN_POWER)
    ...
    public static void registerTowerSpawner(Block type, BlockModelGenerators generator)
    {
        ...
        ResourceLocation defeated_bottom = TextureMapping.getBlockTexture(FRBlocks.TOWER_WATCHER.get(), "_defeated_top");
    ...
    private static JsonObject createArmorJson(ResourceLocation id, Map<TextureSlot, ResourceLocation> textures, Holder<ArmorMaterial> armorMaterial, ItemModelGenerators itemgen) {
        ...
        for (ItemModelHelper.TrimMaterial trimMaterial : TRIM_MATERIALS) {
