...
public class FRAdvancementProvider extends FabricAdvancementProvider
{
    HolderLookup.Provider registryLookup;

    private static final Item[] MODELS_LIST = new Item[] {
            FRBlocks.CREEPER_MODEL.get().asItem(),
            FRBlocks.SKELETON_MODEL.get().asItem(),
            FRBlocks.STRAY_MODEL.get().asItem(),
            FRBlocks.BOGGED_MODEL.get().asItem(),
            FRBlocks.WITHER_SKELETON_MODEL.get().asItem(),
            FRBlocks.ENDERMAN_MODEL.get().asItem(),
            FRBlocks.BLAZE_MODEL.get().asItem(),
            FRBlocks.SLIME_MODEL.get().asItem(),
            FRBlocks.MAGMA_CUBE_MODEL.get().asItem(),
            FRBlocks.PHANTOM_MODEL.get().asItem()
    };

    // Super!
    public FRAdvancementProvider(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registryLookup)
    {
    ...
    private void modAdvFrontiers(Consumer<AdvancementHolder> consumer)
    {
        ...
        AdvancementHolder frontiers_smelt_cobalt = Advancement.Builder.advancement()
                ...
                .addCriterion("got_cobalt", InventoryChangeTrigger.TriggerInstance.hasItems(FRItems.COBALT_INGOT.get()))
        ...
        AdvancementHolder frontiers_smelt_frostite = Advancement.Builder.advancement()
                ...
                .addCriterion("got_frostite", InventoryChangeTrigger.TriggerInstance.hasItems(FRItems.FROSTITE_INGOT.get()))
        ...
        AdvancementHolder frontiers_eat_hpapple = Advancement.Builder.advancement()
                .display(
                        FRItems.APPLE_OF_ENLIGHTENMENT.get(),
                ...
                .parent(frontiers_root)
                .addCriterion("ate_apple", ConsumeItemTrigger.TriggerInstance.usedItem(FRItems.APPLE_OF_ENLIGHTENMENT.get()))
        ...
        AdvancementHolder frontiers_vivulite_armor_full = Advancement.Builder.advancement()
                ...
                .parent(frontiers_smelt_cobalt)
                .addCriterion("viv_helmet", InventoryChangeTrigger.TriggerInstance.hasItems(FRItems.VIVULITE_HELMET.get()))
                .addCriterion("viv_chest", InventoryChangeTrigger.TriggerInstance.hasItems(FRItems.VIVULITE_CHESTPLATE.get()))
                .addCriterion("viv_leggings", InventoryChangeTrigger.TriggerInstance.hasItems(FRItems.VIVULITE_LEGGINGS.get()))
                .addCriterion("viv_boots", InventoryChangeTrigger.TriggerInstance.hasItems(FRItems.VIVULITE_BOOTS.get()))
        ...
        AdvancementHolder frontiers_obtain_vivulite_anvil = Advancement.Builder.advancement()
                .display(
                        ...
                        BG,
                        FRAdvancementFrames.FRONTIERS_ADV,
                        true,
                        true,
                        true
                )
                .parent(frontiers_vivulite_armor_full)
                .addCriterion("obtain_anvil", InventoryChangeTrigger.TriggerInstance.hasItems(FRBlocks.VIVULITE_ANVIL.get()))
        ...
        AdvancementHolder frontiers_brimtan_armor_full = Advancement.Builder.advancement()
                .display(
                        FRItems.BRIMTAN_CHESTPLATE.get(),
                ...
                .parent(frontiers_vivulite_armor_full)
                .addCriterion("brim_helmet", InventoryChangeTrigger.TriggerInstance.hasItems(FRItems.BRIMTAN_HELMET.get()))
                .addCriterion("brim_chest", InventoryChangeTrigger.TriggerInstance.hasItems(FRItems.BRIMTAN_CHESTPLATE.get()))
                .addCriterion("brim_leggings", InventoryChangeTrigger.TriggerInstance.hasItems(FRItems.BRIMTAN_LEGGINGS.get()))
                .addCriterion("brim_boots", InventoryChangeTrigger.TriggerInstance.hasItems(FRItems.BRIMTAN_BOOTS.get()))
        ...
        AdvancementHolder frontiers_glowing_obsidian = Advancement.Builder.advancement()
                ...
                .addCriterion("glowing_obsidian", InventoryChangeTrigger.TriggerInstance.hasItems(FRBlocks.GLOWING_OBSIDIAN.get()))
        ...
        AdvancementHolder frontiers_enter_crags = Advancement.Builder.advancement()
                ...
                .addCriterion("enter_crags", ChangeDimensionTrigger.TriggerInstance.changedDimensionTo(FRDimension.CRAGS_LEVEL_KEY))
        ...
        AdvancementHolder frontiers_purify_crystal = Advancement.Builder.advancement()
                ...
                .display(
                        FRItems.PURIFIED_END_CRYSTAL.get(),
        ...
        AdvancementHolder frontiers_enter_tower = Advancement.Builder.advancement()
                ...
                .addCriterion("entered_tower", PlayerTrigger.TriggerInstance.located(
                        LocationPredicate.Builder.inStructure(registryLookup
                                        ...
                                        .getOrThrow(FRStructures.WHITE_TOWER))
                ))
    ...
    private void modAdvHusbandry(Consumer<AdvancementHolder> consumer)
    {
        AdvancementHolder husbandry_violet_rose = Advancement.Builder.advancement()
                ...
                .addCriterion("got_violet_rose", InventoryChangeTrigger.TriggerInstance.hasItems(FRBlocks.VIOLET_ROSE.get()))
        ...
        AdvancementHolder find_truffle = Advancement.Builder.advancement()
                ...
                .addCriterion("got_truffle", InventoryChangeTrigger.TriggerInstance.hasItems(FRItems.TRUFFLE.get()))
        ...
        AdvancementHolder feed_truffle_to_hoglin = Advancement.Builder.advancement()
                ...
                .addCriterion(
                        ...
                        PlayerInteractTrigger.TriggerInstance.itemUsedOnEntity(
                                ItemPredicate.Builder.item().of(FRItems.TRUFFLE.get()),
                                Optional.of(
        ...
        AdvancementHolder catch_bottled_message = Advancement.Builder.advancement()
                ...
                .addCriterion(
                        ...
                        FishingRodHookedTrigger.TriggerInstance.fishedItem(Optional.empty(), Optional.empty(), Optional.of(ItemPredicate.Builder.item().of(FRItems.BOTTLED_MESSAGE.get()).build()))
                )
        ...
        AdvancementHolder summon_pumpkin_golem = Advancement.Builder.advancement()
                ...
                .addCriterion("summon_pumpkin_golem", SummonedEntityTrigger.TriggerInstance.summonedEntity(EntityPredicate.Builder.entity().of(FREntity.PUMPKIN_GOLEM.get())))
                .save(consumer, "adventure/summon_iron_golem");

        AdvancementHolder throw_fruitcake = Advancement.Builder.advancement()
                .parent(vanillaDummy("husbandry/plant_seed"))
                .display(
                        FRItems.FRUITCAKE_SLICE.get(),
                ...
                .addCriterion(
                        ...
                        KilledTrigger.TriggerInstance.playerKilledEntity(
                                ...
                                DamageSourcePredicate.Builder.damageType()
                                        ...
                                        .direct(EntityPredicate.Builder.entity().of(FREntity.FRUITCAKE.get()))
                        )
                )
    ...
    private void modAdvAdventure(Consumer<AdvancementHolder> consumer)
    {
        AdvancementHolder we_ball = Advancement.Builder.advancement()
                ...
                .addCriterion("hit", PlayerHurtEntityTrigger.TriggerInstance.playerHurtEntityWithDamage(
                        DamagePredicate.Builder.damageInstance().sourceEntity(EntityPredicate.Builder.entity().of(FREntity.BALL.get()).build())
                ))
        ...
        AdvancementHolder sleep_in_phantom_bed = Advancement.Builder.advancement()
                .display(
                        FRItems.PHANTOM_STITCH_BED.get(),
    ...
    private void modAdvNether(Consumer<AdvancementHolder> consumer)
    {
        AdvancementHolder brew_lightning = Advancement.Builder.advancement()
                ...
                .display(
                        FRItems.LIGHTNING_IN_A_BOTTLE.get(),
                ...
                .addCriterion("potion", BrewedItemCriterion.Conditions.of(FRItems.LIGHTNING_IN_A_BOTTLE.get()))
        ...
        AdvancementHolder brimtan_hoe = Advancement.Builder.advancement()
                ...
                .addCriterion("hoe", InventoryChangeTrigger.TriggerInstance.hasItems(FRItems.BRIMTAN_HOE.get()))
        ...
        AdvancementHolder use_enchanting_magnet = Advancement.Builder.advancement()
                ...
                .addCriterion(
                        ...
                        ItemUsedOnLocationTrigger.TriggerInstance.itemUsedOnBlock(
                                LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(FRBlocks.ENCHANTING_MAGNET.get())),
                                ItemPredicate.Builder.item().of(Items.GLASS_BOTTLE)
                        )
                )
                .display(
                        FRBlocks.ENCHANTING_MAGNET.get(),
    ...
    {
        return FRCriteria.SLEPT_ON_PHANTOM_BED.get()
