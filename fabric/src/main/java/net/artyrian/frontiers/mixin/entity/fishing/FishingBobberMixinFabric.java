...
public class FishingBobberMixinFabric
{
    ...
    private boolean invalidHalterMainHand(boolean original, @Local(ordinal = 0) ItemStack itemStack)
    {
        ...
        return itemStack.is(((BobberIntf)self).frontiers_1_21x$getParentItemStack().getItem());
    }
    ...
    {
        FishingHook self = (FishingHook)(Object)(this);
        return itemStack2.is(((BobberIntf)self).frontiers_1_21x$getParentItemStack().getItem());
    }
}
